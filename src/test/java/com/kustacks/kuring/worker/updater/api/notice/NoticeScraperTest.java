...
import com.kustacks.kuring.worker.updater.api.scrap.parser.LegacyPageNoticeHTMLParser;
import com.kustacks.kuring.worker.updater.api.scrap.parser.RealEstateNoticeHTMLParser;
import com.kustacks.kuring.worker.updater.api.scrap.parser.RecentPageNoticeHTMLParser;
import com.kustacks.kuring.worker.updater.api.scrap.parser.RecentPageNoticeHTMLParser2;
import com.kustacks.kuring.worker.updater.deptinfo.DeptInfo;
import com.kustacks.kuring.worker.updater.deptinfo.liberal_art.ChineseDept;
...
public class NoticeScraperTest {
    ...
    public NoticeScraperTest(@Value("${notice.list.legacy-url}") String legacyPageUrl,
                             @Value("${notice.list.recent-url}") String recentPageUrl,
                             @Value("${notice.list.real-estate-url}") String realEstateUrl,
    ...
    class Success {
        ...
        void successForRecent() throws URISyntaxException, IOException {
            ...
            String requestPath = uri.getPath();
            testTemplate(requestPath, legacyDept, 1, koreanFolderName);
        }
        ...
        private void testTemplate(String requestPath, DeptInfo deptInfo, int expectTime, String folderName) throws IOException {
            ...
            // when
            List<CommonNoticeFormatDTO> noticeDTOList = noticeScraper.scrap(deptInfo, true);
        ...
        class HTMLDiff {
            ...
            */
            ...
            private void testTemplate(String requestPath, DeptInfo deptInfo, int expectTime, String folderName) throws IOException {
                ...
                // when, then
                InternalLogicException e = assertThrows(InternalLogicException.class, () -> noticeScraper.scrap(deptInfo, true));
    ...
    private boolean compareDTO(CommonNoticeFormatDTO a, CommonNoticeFormatDTO b) {
        return Objects.equals(a.getArticleId(), b.getArticleId()) &&
            Objects.equals(a.getPostedDate(), b.getPostedDate()) &&
            Objects.equals(a.getSubject(), b.getSubject()) &&
            Objects.equals(a.getBaseUrl(), b.getBaseUrl()) &&
            Objects.equals(a.getFullUrl(), b.getFullUrl());
    }
}
