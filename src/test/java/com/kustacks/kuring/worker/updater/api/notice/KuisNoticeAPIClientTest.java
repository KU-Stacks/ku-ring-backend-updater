...
import com.kustacks.kuring.worker.updater.util.converter.KuisNoticeDTOToCommonFormatDTOConverter;
...
public class KuisNoticeAPIClientTest {
    ...
    void success() {
        ...
        // when
        List<CommonNoticeFormatDTO> notices = kuisNoticeAPIClient.request(CategoryName.BACHELOR, true);
    ...
    void failByBadResponse() {
        ...
        // when, then
        InternalLogicException e = assertThrows(InternalLogicException.class, () -> kuisNoticeAPIClient.request(CategoryName.BACHELOR, true));
