...
import com.kustacks.kuring.worker.updater.deptinfo.architecture.ArchitectureDept;
import com.kustacks.kuring.worker.updater.deptinfo.art_design.*;
import com.kustacks.kuring.worker.updater.deptinfo.business.BusinessAdministrationDept;
import com.kustacks.kuring.worker.updater.deptinfo.business.TechnologicalBusinessDept;
import com.kustacks.kuring.worker.updater.deptinfo.education.*;
import com.kustacks.kuring.worker.updater.deptinfo.engineering.*;
import com.kustacks.kuring.worker.updater.deptinfo.ku_integrated_science.*;
import com.kustacks.kuring.worker.updater.deptinfo.liberal_art.*;
import com.kustacks.kuring.worker.updater.deptinfo.real_estate.RealEstateDept;
import com.kustacks.kuring.worker.updater.deptinfo.sanghuo_biology.*;
import com.kustacks.kuring.worker.updater.deptinfo.sanghuo_elective.ElectiveEducationCenterDept;
import com.kustacks.kuring.worker.updater.deptinfo.sanghuo_elective.VolunteerCenterDept;
import com.kustacks.kuring.worker.updater.deptinfo.science.ChemicalsDept;
import com.kustacks.kuring.worker.updater.deptinfo.science.MathematicsDept;
import com.kustacks.kuring.worker.updater.deptinfo.science.PhysicsDept;
import com.kustacks.kuring.worker.updater.deptinfo.social_science.*;
import com.kustacks.kuring.worker.updater.deptinfo.veterinary_medicine.PreVeterinaryDept;
import com.kustacks.kuring.worker.updater.deptinfo.veterinary_medicine.VeterinaryMedicineDept;
...
public class MappedBeanConfig {
    ...
    public static class ScrapNoticeMappedBeanConfig {
        ...
        private final NoticeAPIClient<ScrapingRequestResultDTO, DeptInfo> legacyPageNoticeAPIClient;
        private final NoticeAPIClient<ScrapingRequestResultDTO, DeptInfo> recentPageNoticeAPIClient;
        private final NoticeAPIClient<ScrapingRequestResultDTO, DeptInfo> realEstateNoticeAPIClient;
        ...
        public ScrapNoticeMappedBeanConfig(NoticeAPIClient<ScrapingRequestResultDTO, DeptInfo> legacyPageNoticeAPIClient,
                                           NoticeAPIClient<ScrapingRequestResultDTO, DeptInfo> recentPageNoticeAPIClient,
                                           NoticeAPIClient<ScrapingRequestResultDTO, DeptInfo> realEstateNoticeAPIClient,
        ...
        @Bean
        public Map<DeptInfo, NoticeAPIClient<ScrapingRequestResultDTO, DeptInfo>> deptInfoNoticeAPIClientMap() {
            HashMap<DeptInfo, NoticeAPIClient<ScrapingRequestResultDTO, DeptInfo>> map = new HashMap<>();
    ...
    @Configuration
    public static class CategoryNameStringEnumMapppedBeanConfig {

        @Bean
        public Map<String, CategoryName> stringCategoryNameMap() {
            Map<String, CategoryName> map = new HashMap<>();
            for (CategoryName categoryName : CategoryName.values()) {
                map.put(categoryName.getName(), categoryName);
            }
            return map;
        }
    }
